...
data parallelism specialization \cite{Govindaraju:2012fn}. DySER
...
or a server \cite{chung13}. LINQits accelerates a domain-specific query
...
and (b) No rewriting or recompiling applications is needed in {\em Transformer} while
...
In \cite{Huang:2009hs}, cache coherency is not considered and the
