...
Cache is becoming the number one area and power consuming component on a CMP system. Thus, we first study L1 cache size as shown in Figure \ref{fig_l1_perf}. 
