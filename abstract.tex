...
that the {\em Transformer} provides significant improvements in terms of performance, up to 14\$times$ for single-type workloads
and 2.3\$times$ for dynamic workloads, as well as energy efficiency, up to 6.9$\times$ for various workloads.
