...
architecture with cores and reconfigurable logic for supporting
...
(up to 14$\times$ for single-type workloads and up to 2.3$\times$ for dynamic
workloads) and energy efficiency (up to 6.9$\times$) for a wide range of
workloads.
