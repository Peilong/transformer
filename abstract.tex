...
schedule accelerator functions. We explore the optimal system parameters, such as L1 and L2 cache sizes, accelerator local buffer sizes, and chip resource
allocation for cores and accelerators, etc. Our simulation results show
